...
def train_model():
    ...
    for root, dirs, files in os.walk(root_dir):
        ...
        print(f"Class Name: {class_name}")  # Debug print
...
def upload():
    ...
    while request.form.get(f'class_name{i}'):
        ...
        class_file = request.files[f'class_name{i}']
...
class UploadForm(FlaskForm):
    class_name0 = StringField('Class 0 Name:', validators=[DataRequired()])
    class0 = FileField('ZIP File:', validators=[DataRequired()])
    class_name1 = StringField('Class 1 Name:', validators=[DataRequired()])
    class1 = FileField('ZIP File:', validators=[DataRequired()])
    class_name2 = StringField('Class 2 Name:', validators=[DataRequired()])
    class2 = FileField('ZIP File:', validators=[DataRequired()])
